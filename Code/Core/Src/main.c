...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, EEPROM_nWC_Pin|QSPI_nCS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, I2S_MCLK_CTRL_Pin|OSD_A2_Pin|OSD_A1_Pin|OSD_A0_Pin
                          |OSD_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, LED_R_Pin|LED_G_Pin|LED_B_Pin|ADDR_nOE_Pin
                          |DATA_nOE_Pin|DATA_CLK_Pin|DATA_IN_Pin|ADDR_CLK_Pin
                          |RAM_nPD_Pin|CAM_PD_Pin|SR_nCLR_Pin|RAM_nDQM_Pin
                          |RAM_nWE_Pin|RAM_nCAS_Pin|RAM_nRAS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(ADDR_IN_GPIO_Port, ADDR_IN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : DIP_1_Pin DIP_3_Pin DIP_4_Pin DIP_5_Pin
                           DIP_6_Pin DIP_2_Pin */
  GPIO_InitStruct.Pin = DIP_1_Pin|DIP_3_Pin|DIP_4_Pin|DIP_5_Pin
                          |DIP_6_Pin|DIP_2_Pin;
  ...
  /*Configure GPIO pins : EEPROM_nWC_Pin QSPI_nCS_Pin */
  GPIO_InitStruct.Pin = EEPROM_nWC_Pin|QSPI_nCS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pins : DIP_7_Pin DIP_8_Pin DIP_9_Pin DIP_10_Pin */
  GPIO_InitStruct.Pin = DIP_7_Pin|DIP_8_Pin|DIP_9_Pin|DIP_10_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pins : I2S_MCLK_CTRL_Pin OSD_A2_Pin OSD_A1_Pin OSD_A0_Pin
                           OSD_EN_Pin */
  GPIO_InitStruct.Pin = I2S_MCLK_CTRL_Pin|OSD_A2_Pin|OSD_A1_Pin|OSD_A0_Pin
                          |OSD_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : HDMI_INT_Pin */
  GPIO_InitStruct.Pin = HDMI_INT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(HDMI_INT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : nREC_Pin */
  GPIO_InitStruct.Pin = nREC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(nREC_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : LED_R_Pin LED_G_Pin LED_B_Pin DATA_CLK_Pin
                           DATA_IN_Pin ADDR_CLK_Pin RAM_nWE_Pin */
  GPIO_InitStruct.Pin = LED_R_Pin|LED_G_Pin|LED_B_Pin|DATA_CLK_Pin
                          |DATA_IN_Pin|ADDR_CLK_Pin|RAM_nWE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : ADDR_nOE_Pin DATA_nOE_Pin RAM_nPD_Pin SR_nCLR_Pin
                           RAM_nDQM_Pin RAM_nCAS_Pin RAM_nRAS_Pin */
  GPIO_InitStruct.Pin = ADDR_nOE_Pin|DATA_nOE_Pin|RAM_nPD_Pin|SR_nCLR_Pin
                          |RAM_nDQM_Pin|RAM_nCAS_Pin|RAM_nRAS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  ...
  /*Configure GPIO pin : ADDR_IN_Pin */
  GPIO_InitStruct.Pin = ADDR_IN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(ADDR_IN_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : CAM_PD_Pin */
  GPIO_InitStruct.Pin = CAM_PD_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(CAM_PD_GPIO_Port, &GPIO_InitStruct);
